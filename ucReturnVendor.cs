...
{
    public partial class ucReturnVendor : UserControl
    {
        public ucReturnVendor()
        {
            InitializeComponent();
            ...
            dataGridView1.Columns["current_quant"].HeaderCell.Value = "出倉總數";
        ...
        private void find_item()
        {
            ...
            {
                MessageBox.Show(this, "資料庫中找不到這個商品", "錯誤");
            }
        }
        ...
        private void ItemsOut()
        {
            ...
            {
                Server.Service sv = new Server.Service();
                if (sv.InventoryOutVendor((DataTable)dataGridView1.DataSource, txtRemarks.Text, 
            ...
            {
                MessageBox.Show(this, ex.Message, "失敗");
            }
            finally
            {
